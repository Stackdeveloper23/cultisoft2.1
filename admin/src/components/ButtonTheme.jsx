...
const ButtonTheme = () => {
    ...
    const handleButtonClick = () => {
        setIsOpen(!isOpen);
        document.getElementById('bd-theme').setAttribute('aria-expanded', !isOpen);
    ...
    return (
        <div className="dropdown bd-mode-toggle">
            {svg()}
            <button
                className={`btn btn-bd-primary py-2 dropdown-toggle d-flex align-items-center ${isOpen ? 'active' : ''}`}
                onClick={handleButtonClick}
                id="bd-theme"
                type="button"
                aria-expanded={isOpen}
                data-bs-toggle="dropdown"
                data-bs-display="static" // Esto fuerza a que el dropdown no se posicione automáticamente.
    data-bs-flip="false" 
            >
                <svg
