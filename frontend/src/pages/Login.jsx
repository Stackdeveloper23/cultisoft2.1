...
/* register */
  ...
  const Submit = async (e) => {
    ...
    <div className="container" id="container" ref={containerRef} >
      ...
      {message && <p>{message}</p>}
          <label>Nombre:</label>
               <input type="text" placeholder="Nombre" required name="name" value={formData.name} onChange={Change}/>
          {errors.name && <p>{errors.name[0]}</p>}

          <label>Email:</label>
               <input type="text" placeholder="Correo" required name="email" value={formData.email} onChange={Change}/>
          {errors.email && <p>{errors.email[0]}</p>}

          <label>Password:</label>
                <input type="text" placeholder="Contraseña" required name="password" value={formData.password} onChange={Change}/>
          {errors.password && <p>{errors.password[0]}</p>}

          <label>Confirm Password:</label>
                <input type="text" placeholder="confirma contraseña" required name="password_confirmation" onChange={Change}/>
...
error
                ...
                <input type="email" placeholder="Correo" required name="email" value={email}
                onChange={(e)=>setEmail(e.target.value)}/>

                <input type="password" placeholder="Contraseña" required name="password" value={password}
        ...
        <div className="toggle-container">
            <div className="toggle">
                ...
                <div className="toggle-panel toggle-right">
                    ...
                    <button className="hidden" id="register" onClick={handleRegisterClick}>Crear cuenta</button>
                </div>
            </div>
        </div>
    </div>
