            ...
            <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div className="modal-content bg-dark text-white">
                    <div className="modal-header">
                        <h1 className="modal-title fs-5" id="staticBackdropLabel">Escribele a nuestro Chatbot tus Inquietudes</h1>
                    ...
                    <div className="modal-body">
                        <div className="chatbot w-100">
                            ...
                            />
                            <button className="button btn btn-primary mt-2" onClick={sendMessage}>Enviar</button>
                        </div>
                    </div>
